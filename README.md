...
- 🗂️ **File Upload System** — Spring Boot + React + Cloudinary + Kafka + Docker
- 🛒 **Ecommerce Platform** — Spring Boot + React + PostgreSQL + Stripe
- 📄 **AI Resume Builder** — Spring Boot, React, Ollama, DeepSeek-R1 | AI powered resume builder using local LLM (DeepSeek-R1 via Ollama) 
...
| ML Mental Health Detection(https://github.com/Sushrut-Kadate/AI-Based-Mental-Health-Detection-via-Social-Media-Analysis) | FastAPI, Python, BERT, LSTM | Sentiment analysis based mental health detection via social media |
...
<p>
  ...
  <a href="https://github.com/Sushrut-Kadate" target="_blank">
    <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/github/github-original.svg" alt="github" width="40" height="40"/>
  </a>
</p>
